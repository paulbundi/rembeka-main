...
import DeliveryRequestFilter from './DeliveryRequestFilter.vue';

export default {
  name: 'DeliveryRequestIndex',
  components: {
  ...
  computed: {
    ...mapState({
      requests: state => state.DeliveryRequests.items,
      loading: state => state.DeliveryRequests.loadingItems,
  ...
  methods: {
    ...
    fetchItems() {
      ...
      this.setProperty({property: 'relations', value: ['admin', 'order', 'driver']});
      this.fetchAll();
    },
  ...
  <div>
    ...
    <div class="card">
      <div v-loading="loading" class="card-body">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="request in requests" :key="request.id">
                ...
                <td>{{request.driver.first_name}} {{request.driver.last_name}}</td>
                <td>
        ...
        <pagination class="pull-left" module="DeliveryRequests" @page-change="pageChange"/>
      </div>
    </div>
  </div>
</template>
