...
export default {
  ...
  computed: {
    ...mapState({
      ...
      loading: state => state.Brands.loadingItems,
  ...
  methods: {
    ...mapActions('Brands',['fetchAll', 'setProperty', 'persist', 'destroy', 'setSelected', 'resetSelected', 'setPaginate']),
