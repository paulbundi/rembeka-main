     ...
     <div class="col-sm-4">
          ...
          <div class="card">
               <div class="card-body">
                    ...
                    <div class="mb-0 border-top pt-2">
                         ...
                         <hr/>
                         <span class="text-dark fw-bolder"> {{ $providers }} - </span>
                         <span>Providers</span>
                         <hr/>
                         <span class="text-dark fw-bolder"> {{  number_format($providersWallet) }} - </span>
          ...
          <div class="card">
               <div class="card-body">
                    ...
                    <div class="mb-0">
                         <span class="text-primary">Products:</span> <b class="text-danger">{{ $services}}</b><br/>
                    </div>
               </div>
          </div>
