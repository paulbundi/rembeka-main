...
<body class="bg-secondary">
  ...
  <div class="whatsapp-mobile d-none" id="whatsapp-mobile">
    <a href="https://wa.me/{{config('services.whatsapp.rembeka_whatsapp_no')}}?text={{ urlencode(url()->current()) }}"
      target="_blank">
  ...
  <div class="whatsapp-web" id="whatsapp-web">
    <a href="https://web.whatsapp.com/send?phone={{config('services.whatsapp.rembeka_whatsapp_no')}}&text={{urlencode(url()->current())}}"
      target="_blank">
  ...
  <!-- Main theme script-->
  <script src="https://cdn.jsdelivr.net/npm/card@2.0.0/dist/card.min.js"></script>
