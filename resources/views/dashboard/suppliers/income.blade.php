...
@if(!$supplier->user)
     <div class="alert alert-danger">
          No Wallet attached, attach wallet first.
     </div>
@else
<div class="row">
                    ...
                    <div class="col-sm-6">
                         ...
                         <div class="card">
                              <div class="card-body">
                                   <div class="row">
                                        <div class="col mt-0">
                                             <h5 class="card-title">Fullfilled Orders fff</h5>
                                        </div>
                         ...
                         <div class="card">
                              <div class="card-body">
                                   <div class="row">
                                        ...
                                        <h1 class="mt-1 mb-2">Ksh {{number_format($supplier->user->wallet,2)}}</h1>
                                   <div class="mb-0">
                                        <hr/>
                                        <a href="/transaction-history/{{$supplier->user_id}}/"><i class="bi bi-eye"></i>Transaction History</a>
                                        <hr/>

                                        @if($supplier->user->wallet > 10)
                                        <form method="POST" action="{{ route('withdraw-for-provider') }}" onSubmit="handleSumbmitForm()">
                                             ...
                                             <div class="form-group">
                                                  <label>Send to Supplier Mpesa</label><br/>
                                                  <b>({{ $supplier->user->phone }})</b>
               ...
               <table class="table table-borderless my-0">
                    <thead>
                         <tr class="border">
                              ...
                              <th class="d-none d-xl-table-cell text-end">Provider cost</th>
                         ...
                         @foreach($pendingOrders as $order)
                              @foreach($order->items as $item)
                                   <tr>
                                        ...
                                        <td>
                                             <small>
                                              Ksh{{ number_format($item->provider_amount * ((100 + $item->percentage_commission) / 100),2) }}
                                             </small> <br/>
