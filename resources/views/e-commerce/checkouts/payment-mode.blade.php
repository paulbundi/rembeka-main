                ...
                <div class="accordion-body">
                  ...
                  @if(isset($response['type']) && $response['type'] == 'success')
                    ...
                    <div class="col-12 d-flex flex-column justify-content-center">
                      ...
                      <p>Please send <strong>Ksh
                          {{ isset($response['order']) && $response['order'] ? number_format($response['order']->balance, 2) : '--' }}</strong>
                  ...
                  <div class="alert alert-info mt-3" role="alert">
                    ...
                    <p class="mb-2 small text-muted">
                      ...
                      Use your <strong>Order No.
                        #{{ isset($response['order']) && $response['order'] ? $response['order']->order_no : '--' }}</strong>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3 w-100">
                          ...
                          <input class="form-control" name="amount" type="number" step="0.01" min="1" id="manual-amount"
                            value="{{ isset($response['order']) && $response['order'] ? number_format($response['order']->balance, 2) : old('amount') }}"
                            required>
                          @error('amount')
                            <small class="text-danger">{{ $message }}</small>
                          @enderror
