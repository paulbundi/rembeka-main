...
import ProviderPricing from './product-tabs/ProviderPricing.vue';
...
methods: {
  ...mapActions('Services', ['fetchOne','persist', 'setProperty', 'attachRelations','detachRelations']),
	fetchItems() {
		this.setProperty({
			property: 'relations',
			value:['attachments.media', 'provider', 'providerPricing', 'category', 'menu', 'ageGroups']
		});
...
<template>
  <div class="card">
		<div class="card-body">
  		<h4 class="text-primary mt-2">Service Details</h4>
			<form>
