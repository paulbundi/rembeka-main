    ...
    <main style="padding-top: 5rem;">
        <div class="container py-5">
            <div class="bg-white rounded-3 p-4 p-md-5 shadow-sm mb-4">
                ...
                <p class="mb-0"><i class="ci-location me-2" style="color:#c12c5d;"></i> <strong>Address:</strong> Mpaka Rd, Nairobi, Kenya</p>
            </div>
            <div class="bg-light rounded-3 p-2 p-md-3">
                <div id="map" style="height: 450px; width: 100%; border-radius: 0.375rem; border: 1px solid #dee2e6; overflow: hidden;"></div>
            </div>
        </div>
    </main>
@endsection
...
@push('scripts')
    ...
    <script>
        function initMap() {
            const map = L.map('map').setView([-1.2630, 36.8080], 15);
