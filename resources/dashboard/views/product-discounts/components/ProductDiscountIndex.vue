...
export default {
  ...
  computed: {
    ...mapState({
      items: state => state.ProductDiscounts.items,
      loading: state => state.ProductDiscounts.loadingItems,
  ...
  methods: {
    ...mapActions('ProductDiscounts',['fetchAll', 'setProperty', 'persist', 'destroy', 'setSelected', 'resetSelected', 'setPaginate']),
  ...
  <div>
    <div class="card">
      ...
      <div v-loading="loading" class="card-body">
                ...
                <td>
                  <div class="dropdown show">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" :aria-labelledby="`dropdownAction${discount.id}`">
                      <a v-if="canUserAccess('products.update')" class="dropdown-item" :href="`/dicscounted/${discount.id}/edit`">Edit</a>
        ...
        <pagination class="pull-left" module="ProductDiscounts" @page-change="pageChange"/>
      </div>
    </div>
  </div>
</template>
