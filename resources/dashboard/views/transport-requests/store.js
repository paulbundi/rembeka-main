...
const state = {
  ...commonState(EMPTY_ENTITY, 'transport-requests'),
  schoolId: null,
  emailFilter: null,
  phoneFilter: null,
  roleFilter: null,
  hideAccessToWeb: false,
};
...
const actions = {
  ...
  transportRequestApprove({ commit }, payload) {
    return api.transportRequestApprove(payload);
  },
  transportRequestDenny({ commit }, payload) {
    return api.transportRequestDenny(payload);
  },
